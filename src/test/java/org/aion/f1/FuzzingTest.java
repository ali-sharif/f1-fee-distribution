...
import static org.aion.f1.RewardsManager.*;
...
public class FuzzingTest {
    ...
    public void testVectorSimple() {
        ...
        events.add(new Event(EventType.VOTE, addressOf(1), 1, 3400L));
        events.add(new Event(EventType.VOTE, addressOf(2), 1, 5700L));
        events.add(new Event(EventType.VOTE, addressOf(2), 2, 2000L));
        events.add(new Event(EventType.BLOCK, null, 2, REWARD));
        events.add(new Event(EventType.VOTE, addressOf(3), 3, 6000L));
        events.add(new Event(EventType.VOTE, addressOf(4), 4, 1500L));
        events.add(new Event(EventType.VOTE, addressOf(5), 4, 6000L));
        events.add(new Event(EventType.BLOCK, null, 7, REWARD));
        events.add(new Event(EventType.BLOCK, null, 8, REWARD));
        events.add(new Event(EventType.BLOCK, null, 11, REWARD));
        events.add(new Event(EventType.WITHDRAW, addressOf(2), 12, null));
        events.add(new Event(EventType.WITHDRAW, addressOf(3), 12, null));
        events.add(new Event(EventType.WITHDRAW, addressOf(4), 12, null));
        events.add(new Event(EventType.VOTE, addressOf(5), 12, 1200L));
        events.add(new Event(EventType.UNVOTE, addressOf(2), 12, 3000L));
        events.add(new Event(EventType.BLOCK, null, 25, REWARD));
        events.add(new Event(EventType.WITHDRAW, addressOf(5), 26, null));
        events.add(new Event(EventType.BLOCK, null, 32, REWARD));
        events.add(new Event(EventType.WITHDRAW, addressOf(4), 36, null));
        events.add(new Event(EventType.WITHDRAW, addressOf(5), 36, null));
            ...
            for (int j = 0; j < numActions; j++) {
                ...
                if (!rm.getStakeMap().containsKey(user)) {
                    ...
                    if (choice == 1) { // vote more
                        ...
                        if (pendingRewards > 0)
                            v.add(new Event(EventType.WITHDRAW, user, i, null));
                    }
                }
            }
