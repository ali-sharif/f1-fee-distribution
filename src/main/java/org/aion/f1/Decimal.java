 ...
 *
 * We pick 18 precision places as the "precision" in this proof of concept.
 *
...
public class Decimal {
    ...
    // utility functions
    public boolean equals(Decimal d) { return value.compareTo(d.value) == 0; }
    public boolean greaterThan(Decimal d) { return value.compareTo(d.value) > 0; }
    public boolean greaterThanOrEqualTo(Decimal d) { return value.compareTo(d.value) >= 0; }
    public boolean lessThan(Decimal d) { return value.compareTo(d.value) < 0; }
    public boolean lessThanOrEqualTo(Decimal d) { return value.compareTo(d.value) <= 0; }
